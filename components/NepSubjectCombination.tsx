...
import { useNepCombinationStore, NepSubjectCombination, SubjectDetails } from "@/store/form";
...
//     const semester = 1;
//     const programme = "b.a";
//     const major = useNepCombinationStore((state) => state.major);
//     const minor = useNepCombinationStore((state) => state.minor);
//     const mdc = useNepCombinationStore((state) => state.mdc);
//     const sec = useNepCombinationStore((state) => state.sec);
//     const aec = useNepCombinationStore((state) => state.aec);
//     const vac = useNepCombinationStore((state) => state.vac);
//     const update = useNepCombinationStore((state) => state.update);

//     const data = useMemo(() => {
//         return nep[programme][semester];
//     }, [programme, semester]);
...
//                                         onClick={() => {
//                                             update("major", item);
//                                             update("minor", data.minor.find(el => String(el.subject).toLowerCase() === String(item.subject).toLowerCase()) || null);
//                                             update("mdc", data.mdc.find(el => String(el.subject).toLowerCase() === String(item.subject).toLowerCase()) || null);
//                                         }}
//                                         isChecked={!!major && major?.code === item.code && major?.paper === item.paper}
//                                     />
//                                 </td>
...
//                                         onClick={() => { }}
//                                         isDisabled
//                                         isChecked={!!minor && minor?.code === item.code && minor?.paper === item.paper}
//                                     />
//                                 </td>
//                                 <td className="whitespace-nowrap px-4 py-2 font-medium text-gray-900 w-10">
//                                     {item.code}
...
//                                         onClick={() => { }}
//                                         isDisabled
//                                         isChecked={!!mdc && mdc?.code === item.code && mdc?.paper === item.paper}
//                                     />
//                                 </td>
//                                 <td className="whitespace-nowrap px-4 py-2 font-medium text-gray-900 w-10">
//                                     {item.code}
...
//                                 <td className="sticky inset-y-0 start-0 bg-white pl-5  w-5">
//                                     <Checkbox
//                                         onClick={() => update("sec", item)}
//                                         isChecked={!!sec && sec?.code === item.code && sec?.paper === item.paper}
//                                     />
//                                 </td>
//                                 <td className="whitespace-nowrap px-4 py-2 font-medium text-gray-900 w-10">
//                                     {item.code}
...
//                             <Option
//                                 key={index}
//                                 onClick={() => update("aec", item)}
//                                 isChecked={!!aec && aec?.code === item.code && aec?.paper === item.paper}
...
//                             <Option
//                                 key={index}
//                                 onClick={() => update("vac", item)}
//                                 isChecked={!!vac && vac?.code === item.code && vac?.paper === item.paper}
//                                 value={`[${item.code}] ${item.paper}`}
//                             />
//                         ))
//                     }
